...
public class SignupNewActivity extends AppCompatActivity implements DialogClickListener,GoogleApiClient.ConnectionCallbacks,ISignUpServiceListener, GoogleApiClient.OnConnectionFailedListener {

    private static final String TAG = SignupNewActivity.class.getName();
...
//                    Toast.makeText(getApplicationContext(), "Registration token:" + regId, Toast.LENGTH_LONG).show();
        ...
        tabLayout.addTab(tabLayout.newTab().setText("Create an account"));
